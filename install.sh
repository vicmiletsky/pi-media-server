...
sudo mount /dev/sdb2 /mnt/Seagate8TB -o uid=1000,gid=1000,umask=000
...
echo "sudo mount /dev/sdb2 /mnt/Seagate8TB -o uid=1000,gid=1000,umask=000" | sudo tee -a /etc/rc.local
